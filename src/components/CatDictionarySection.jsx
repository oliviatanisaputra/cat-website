    ...
    const dictionaryItems = [
        {
            ...
            info: "‘도시생태계의 일부’로, 쥐나 해충을 잡아주는 역할을 한다. 하지만 사람과의 공존 문제(배설물, 울음소리, 쓰레기 봉투 훼손 등) 때문에 갈등이 생기기도 한다. 대부분 중성화(TNR)된 개체는 번식을 하지 않으며, 일정 구역을 중심으로 생활함. 사람의 돌봄(밥, 물, 잠자리 등)에 익숙한 경우도 있다.",
        },
        {
            id: 2,
            subtitle: "주의 사항",
            info: "1. 만지거나 갑자기 다가가지 않기 → 낯선 사람을 경계하므로 공격하거나 도망칠 수 있음.;2. 학교에서 고양이와의 거리 유지 → 교내 위생 문제나 안전을 위해 학교 규칙에 따라 행동해야 함.;3. 먹이 급식소·TNR 프로그램 협력 → 함부로 밥을 주기보다, 학교나 지역센터와 협력해서 체계적으로 관리해야 함.;4. 다친 고양이 발견 시 신고 → 지역 동물보호센터나 구청 동물복지팀에 연락하기."
        },
        {
            id: 3,
