        ...
        <div>
            ...
            <div className="cardslist">
                ...
                <div className="card emergencyinfo">
                    ...
                    <ol>
                        <li>공격하는 이유: 고양이가 공격성을 보일 때는 영역을 지키거나 새끼가 있는 어미 고양이가 새끼를 지키기 위해 공격성을 보일 수가 있습니다.</li>
                        <li>대처 요령: 고양이와 거리 유지, 발을 구르거나 큰 소리로 위협하지 않기</li>
                        <li>피해 시 조치: 물림, 할큄은 즉시 상처를 소독하고 병원에 가서 파상풍·항생제 등 치료, 광견병 예방접종과 바르토넬리증 등 감염 가능성이 있어 병원에 가서 검사.</li>
                            <ul>
